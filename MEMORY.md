...
- [P1Monitor → InfluxDB pipeline](project_p1monitor_influxdb_pipeline.md) — bucket `p1monitor`, MQTT broker 192.168.10.5:1883; historical import via Telegraf `inputs.sql`, template at /home/wilco/github/P1monitor/ (Fedora)
